...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< S4 >::type retval(retvalSEXP);
    Rcpp::traits::input_parameter< bool >::type keep_hashing_mapping(keep_hashing_mappingSEXP);
    __result = Rcpp::wrap(hashed_model_matrix_dataframe(tf, data, hash_size, transpose, retval, keep_hashing_mapping));
    return __result;
>>>>>>> origin/master
END_RCPP
}
...
BEGIN_RCPP
    ...
    __result = Rcpp::wrap(tag_existence(src, delim));
    return __result;
END_RCPP
}
// tag_count
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< CharacterVector >::type src(srcSEXP);
    Rcpp::traits::input_parameter< const std::string& >::type delim(delimSEXP);
    __result = Rcpp::wrap(tag_count(src, delim));
    return __result;
END_RCPP
}
